...
Hive navigation labels support a constrained safe HTML-like subset. For example, paste this into a sidebar rename field:

`<span class="hive-glow" style="color:#ffd84a">MUSIC</span>`

The supported animated classes are `hive-pulse`, `hive-rainbow`, and `hive-glow`.
